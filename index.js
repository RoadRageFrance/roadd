...
bot.on('message', message => {
    ...
    if(message.content.startsWith(prefix + "help")) {
        ...
        "**t!warn** ou **t!wn** Pour envoyer un avertissement à un membre du serveur (Staff uniquement)"
        )
...
}else{ const args = message.content.split(' ').slice(1);
  ...
  if (message.mentions.users.size != 0) {
    ...
    if (args[0] === "<@!"+mentioned.id+">"||args[0] === "<@"+mentioned.id+">") {
      ...
      if (args.slice(1).length != 0) {
        ...
        } else {warns[message.guild.id][mentioned.id][warnumber+1] = {"raison": args.slice(1).join(' '),
                  ...
                  if (message.mentions.users.size != 0) {
                    ...
                    if (args[0] === "<@!"+mentioned.id+">"||args[0] === "<@"+mentioned.id+">"){
                      ...
                      if (!isNaN(arg2)) {
                        ...
                        return;  message.channel.send("Erreur mauvais usage: "+prefix+"deletewarns <utilisateur> <nombre>");
